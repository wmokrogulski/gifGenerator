...
OutFile "setup.exe"
InstallDir "$PROGRAMFILES\GifGenerator"
...
Section -Post
  ...
  WriteRegStr HKLM "${PRODUCT_DIR_REGKEY}" "" "$INSTDIR\gifFromFrames.exe"
  WriteRegStr ${PRODUCT_UNINST_ROOT_KEY} "${PRODUCT_UNINST_KEY}" "DisplayName" "$(^Name)"
  WriteRegStr ${PRODUCT_UNINST_ROOT_KEY} "${PRODUCT_UNINST_KEY}" "UninstallString" "$INSTDIR\uninst.exe"
  WriteRegStr ${PRODUCT_UNINST_ROOT_KEY} "${PRODUCT_UNINST_KEY}" "DisplayIcon" "$INSTDIR\gifFromFrames.exe"
...
Section Uninstall
  ...
  Delete "$INSTDIR\gifFromVideo.exe"
  Delete "$INSTDIR\gifFromFrames.exe"
